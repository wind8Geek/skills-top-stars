...
> 来源：[wind8ai 的 skills 列表](https://github.com/stars/wind8ai/lists/skills) · 更新：2026-09-08
...
- [superpowers](#1-obrasuperpowers-283k-) — 完整的 coding agent 软件开发方法论与技能框架
- [skills](#2-mattpocockskills-256k-) — Matt Pocock 的个人 skills 目录，直接从他的 .claude 目录整理而来
- [ECC](#3-affaan-mecc-253k-) — 面向 Claude Code、Codex、OpenCode 与 Cursor 等 coding agent 的工程优化系…
- [andrej-karpathy-skills](#4-multica-aiandrej-karpathy-skills-211k-) — 整理自 Andrej Karpathy（前 OpenAI / Tesla AI 负责人）的 LLM 编码陷阱观察，以单个…
- [ponytail](#7-dietrichgebertponytail-131k-) — 让 AI agent 像「最懒的 senior dev」一样思考：最好的代码，是你从未写下的那部分
- [caveman](#9-juliusbrusseecaveman-104k-) — Claude Code Token 优化 Skill：用「原始人」式极简表达削减约 65% token 消耗，少字了事
- [agent-skills](#10-addyosmaniagent-skills-93k-) — 生产级 AI coding agent 工程技能集合
- [skills](#20-emilkowalskiskills-36k-) — 面向设计师与工程师的 Agent Skills 集合，覆盖 Web、Expo 与 Apple 平台的动画设计、交互动效评…
- [reverse-skill](#22-zhaoxuya520reverse-skill-35k-) — 面向经授权逆向工程、渗透测试与安全研究的 Agent Skill 路由包
- [Anthropic-Cybersecurity-Skills](#24-mukul975anthropic-cybersecurity-skills-32k-) — 社区维护的网络安全 Agent Skills 库，按 agentskills.io 标准覆盖安全运营、取证、威胁狩猎、渗…
...
- [ui-ux-pro-max-skill](#8-nextlevelbuilderui-ux-pro-max-skill-126k-) — 面向多平台专业 UI/UX 构建的设计智能 Skill，为 AI coding agent 提供设计决策与界面产出能力
- [taste-skill](#11-leonxlnxtaste-skill-85k-) — 开源设计品味技能，为 Cursor、Codex、Claude Code、Devin 等 AI coding agent …
- [archify](#16-tt-a1iarchify-53k-) — 将代码库或系统描述转为可验证交互式系统地图的 Agent Skill，以类型化 JSON IR 和确定性检查生成自包含 …
- [skills](#20-emilkowalskiskills-36k-) — 面向设计师与工程师的 Agent Skills 集合，覆盖 Web、Expo 与 Apple 平台的动画设计、交互动效评…
- [diagram-design](#23-cathrynlaverydiagram-design-33k-) — 面向 Claude Code、Codex 与 Pi 的编辑级图表设计 Skill，提供 38 种架构、流程、数据与战略图…
- [awesome-gpt-image-2](#28-freestyleflyawesome-gpt-image-2-29k-) — 面向 GPT-Image-2 的 Prompt-as-Code 引擎、案例库与 Agent Skill，将大量图像生成案…
- [hallmark](#29-nutlopehallmark-28k-) — 面向 Claude Code、Cursor 与 Codex 的反 AI 同质化设计 Skill，通过明确的视觉约束帮助 …
- [baoyu-skills](#32-jimliubaoyu-skills-26k-) — 宝玉分享的 AI Agent 技能集（适用于 Claude Code、Codex 等），提升日常工作效率

### 📚 研究、写作与知识管理

- [last30days-skill](#14-mvanhornlast30days-skill-62k-) — AI agent 研究技能，可跨 Reddit、X、YouTube、Hacker News、Polymarket 及全网…
- [obsidian-skills](#18-kepanoobsidian-skills-48k-) — Obsidian 的 Agent Skills，教你的 agent 如何使用 Markdown、Bases、JSON C…
- [academic-research-skills](#19-imbad0202academic-research-skills-47k-) — 面向 Claude Code 的学术研究 Skills：研究 → 写作 → 审阅 → 修订 → 定稿，覆盖学术论文全流程
- [book-to-skill](#27-virgiliojr94book-to-skill-29k-) — 将技术书籍 PDF 一键转为 Claude Code Skill，便于边开发边查阅、学习与引用书中知识
...
- [pm-skills](#31-phurynpm-skills-26k-) — 产品管理技能市场：100+ agent 技能、命令和插件，覆盖 discovery、策略、执行、发布和增长
- [agency-agents-zh](#36-jnmetacodeagency-agents-zh-20k-) — 266 个即插即用的 AI 专家角色，覆盖工程/设计/营销/金融等 20 个部门；含 50 个中国市场原创智能体，配合 …

### 🌐 标准、生态与 Skills 合集

- [skills](#5-anthropicsskills-175k-) — Anthropic 官方 Agent Skills 实现
...
- [awesome-claude-skills](#12-composiohqawesome-claude-skills-75k-) — Claude Skills 精选列表，涵盖工作流定制、资源工具、实践案例
- [awesome-claude-code](#15-hesreallyhimawesome-claude-code-54k-) — Claude Code 精选 Skills、Hooks、Slash Commands、Agent 编排器、应用和插件列表
- [awesome-openclaw-skills](#17-voltagentawesome-openclaw-skills-52k-) — OpenClaw Skills 大全
- [claude-plugins-official](#21-anthropicsclaude-plugins-official-36k-) — Anthropic 官方维护的高质量 Claude Code Plugins 目录
- [agent-skills](#25-vercel-labsagent-skills-31k-) — Vercel 官方 agent skills 集合
- [skills](#26-vercel-labsskills-31k-) — `npx skills` 工具——开源 agent skills 命令行工具
- [skills](#30-openaiskills-26k-) — Codex Skills 目录
- [baoyu-skills](#32-jimliubaoyu-skills-26k-) — 宝玉分享的 AI Agent 技能集（适用于 Claude Code、Codex 等），提升日常工作效率
- [claude-skills](#33-alirezarezvaniclaude-skills-26k-) — 337 Claude Code skills 和 agent 插件集合，覆盖 Claude Code、Codex、Gem…
